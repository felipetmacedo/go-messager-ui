...
export function Sidebar({
  ...
  const mappedIndividualChats = filteredChats.map((chat: any) => ({
    ...
    avatar:
      chat.user_id === chat.user.id ? chat.receiver.avatar : chat.user.avatar,
      ...
      {!isCollapsed && (
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <h1 className="text-4xl font-medium  text-black mt-4 md:mt-0">
              Go Message
            </h1>
          </div>
          ...
          <nav className="grid gap-1 px-2 group-[[data-collapsed=true]]:justify-center group-[[data-collapsed=true]]:px-2">
            {filteredChats.length > 0 ? (
                ...
                isCollapsed ? (
                  ...
                  <button
                    ...
                    className={cn(
                      buttonVariants({
                        variant:
                          selectedChat?.id === chat.id ? "secondary" : "ghost",
                        size: "lg",
                      }),
                      selectedChat?.id === chat.id &&
              ...
              <div className="flex flex-col items-center justify-center py-10 px-4 text-center">
                ...
                <h3 className="font-medium mb-1">Nenhum chat encontrado</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  Não encontramos nenhum chat com o termo pesquisado.
                </p>
                {searchTerm && (
                  <Button
                    variant="outline"
